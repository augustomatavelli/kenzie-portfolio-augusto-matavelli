			...
			<AboutSection id="about">
				<Container>
					...
					<Text as="h4" type="body1" color="grey1">
						...
						também em lógica de automação e isso despertou um interesse em
						migrar para a área de tecnologia. No cargo de gestão, pude estudar e
						aprimorar algumas soft skills como inteligência emocional e
						feedbacks.
					</Text>
					<br />
					<Text as="h4" type="body1" color="grey1">
					...
					<ProjectAreaWrapperColumns>
						<ProjectsAreaSocialMediaMessage>
							...
							<Text as="p" type="body1" color="grey2">
								No LinkedIn, compartilho meus principais projetos e estou
								disposto a trocar algumas ideias
							</Text>
							<Button
								type="primary"
								target="_blank"
